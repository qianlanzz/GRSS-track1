...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_model', default="/data/zzq/zz/DFC2025-OEM-SAR-Baseline-master/model/unetplusplus-efficientnet-b4/SAR_Pesudo_unetplusplus-efficientnet-b4_s0_CELoss_0.3626864648694513.pth") 
